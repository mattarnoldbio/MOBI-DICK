...
[[ $paired == true ]] && prinseq-lite.pl -lc_method dust -lc_threshold 7 -derep 12345 -fastq $R1 -fastq2 $R2 -out_good ${reads}/prinseq_good -out_bad ${reads}/prinseq_bad > ${reads}/prinseq_out.txt 2>&1 || prinseq-lite.pl -lc_method dust -lc_threshold 7 -derep 12345 -fastq $R1 -out_good ${reads}/prinseq_good -out_bad ${reads}/prinseq_bad > ${reads}/prinseq_out.txt 2>&1 # Run prinseq
